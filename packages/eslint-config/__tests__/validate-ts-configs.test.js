...
describe('Validate TS configs', () => {
  it('Validate ise-fe-eslint-config/typescript', async () => {
  ...
  it('Validate ise-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate ise-fe-eslint-config/typescript/node', async () => {
