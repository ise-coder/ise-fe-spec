...
describe('Validate TS configs', () => {
  it('Validate eslint-config-ise/typescript', async () => {
  ...
  it('Validate eslint-config-ise/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ise/essential/typescript', async () => {
  ...
  it('Validate eslint-config-ise/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-ise/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ise/typescript/node', async () => {
