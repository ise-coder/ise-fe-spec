...
describe('Validate JS configs', () => {
  it('Validate ise-fe-eslint-config', async () => {
  ...
  it('Validate ise-fe-eslint-config/es5', async () => {
  ...
  it('Validate ise-fe-eslint-config/vue', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate ise-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate ise-fe-eslint-config/node', async () => {
