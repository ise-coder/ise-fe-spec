...
describe('Validate JS configs', () => {
  it('Validate eslint-config-ise', async () => {
  ...
  it('Validate eslint-config-ise/es5', async () => {
  ...
  it('Validate eslint-config-ise/vue', async () => {
  ...
  it('Validate eslint-config-ise/essential', async () => {
  ...
  it('Validate eslint-config-ise/essential/es5', async () => {
  ...
  it('Validate eslint-config-ise/essential/react', async () => {
  ...
  it('Validate eslint-config-ise/essential/vue', async () => {
  ...
  it('Validate eslint-config-ise/node', async () => {
