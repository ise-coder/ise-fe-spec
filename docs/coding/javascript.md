...
- 1.1.1.【强制】使用 2 个空格缩进。`eslint`: [indent](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/indent.md)
...
- 1.2.1.【强制】使用分号。`eslint`: [semi](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/semi.md)
...
- 1.3.1.【强制】对于逗号分隔的多行结构，不使用行首逗号。`eslint`: [comma-style](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/comma-style.md)
...
- 1.3.2.【强制】对于逗号分隔的多行结构，始终加上最后一个逗号。`eslint`: [comma-dangle](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/comma-dangle.md)
...
- 1.4.1【推荐】始终使用大括号包裹代码块。eslint: [curly](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/curly.md) [nonblock-statement-body-position](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/nonblock-statement-body-position.md)
...
- 1.4.2.1.【强制】对于非空代码块，采用 `Egyptian Brackets` 风格。eslint: [brace-style](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/brace-style.md)
...
- 1.4.3.【强制】不要使用空代码块。`eslint`: [no-empty](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-empty.md)
...
- 1.5.1.【强制】空格风格。`eslint`: [space-before-blocks](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/space-before-blocks.md) [keyword-spacing](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/keyword-spacing.md) [space-in-parens](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/space-in-parens.md) [array-bracket-spacing](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/array-bracket-spacing.md) [object-curly-spacing](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/object-curly-spacing.md) [space-infix-ops](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/space-infix-ops.md) [key-spacing](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/key-spacing.md)
...
- 1.6.1.【推荐】在文件末尾保留一行空行。`eslint`: [eol-last](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/eol-last.md)
...
- 1.6.2.【强制】块的开始和结束不能是空行。`eslint`: [padded-blocks](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/padded-blocks.md)
...
- 1.7.1.【推荐】单行最大字符数：100。`eslint`: [max-len](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/max-len.md)
...
- 1.7.2.【参考】文件最大行数：1000。`eslint`: [max-lines](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/max-lines.md)

  过长的文件不易阅读和维护，最好对其进行拆分。

- 1.7.3.【参考】函数最大行数：80。`eslint`: [max-lines-per-function](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/max-lines-per-function.md)
...
- 2.1.1.【强制】使用 `const` 或 `let` 声明变量。`eslint`: [no-var](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-var.md) [no-undef](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-undef.md)
...
- 2.1.2.【强制】正确地使用 `const` 和 `let`。`eslint`: [prefer-const](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/prefer-const.md)
...
- 2.1.3.【强制】一条声明语句声明一个变量。`eslint`: [one-var](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/one-var.md)
...
- 2.1.4.【强制】声明的变量必须被使用。`eslint`: [no-unused-vars](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-unused-vars.md)
...
- 2.1.5.【强制】不要在声明前就使用变量。`eslint`: [no-use-before-define](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-use-before-define.md)
...
- 2.1.7.【强制】变量不要与外层作用域已存在的变量同名。`eslint`: [no-shadow](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-shadow.md)
...
- 2.1.8.【强制】不要重复声明变量和函数。`eslint`: [no-redeclare](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-redeclare.md)
...
- 2.1.9.【强制】禁止连续赋值。`eslint`: [no-multi-assign](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-multi-assign.md)
...
- 2.2.1.【强制】不要使用 `new Number/String/Boolean`。`eslint`: [no-new-wrappers](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-new-wrappers.md)
...
- 2.2.3.【推荐】使用 `parseInt()` 方法时总是带上基数。`eslint`: [radix](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/radix.md)
...
- 2.2.4.【强制】避免不必要的布尔类型转换。`eslint`: [no-extra-boolean-cast](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-extra-boolean-cast.md)
...
- 2.2.5.1.【强制】字符串优先使用单引号。`eslint`: [quotes](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/quotes.md)
...
- 2.2.5.2.【推荐】使用模板字符串替代字符串拼接。eslint: [prefer-template](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/prefer-template.md)
...
- 2.2.5.3.【强制】禁止不必要的转义字符。[no-useless-escape](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-useless-escape.md)
...
- 2.3.1.【强制】使用字面量创建数组。`eslint`: [no-array-constructor](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-array-constructor.md)
...
- 2.3.2.【强制】某些数组方法的回调函数中必须包含 `return` 语句。`eslint`: [array-callback-return](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/array-callback-return.md)
...
- 2.4.1.【强制】使用字面量创建对象。`eslint`: [no-new-object](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-new-object.md)
...
- 2.4.2【强制】使用对象属性和方法的简写语法。`eslint`: [object-shorthand](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/object-shorthand.md)
...
- 2.4.4.【强制】对象的属性名不要用引号包裹，除非包含特殊字符。`eslint`: [quote-props](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/quote-props.md)
...
- 2.4.5.【强制】优先使用 . 访问对象的属性。`eslint`: [dot-notation](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/dot-notation.md)
...
- 2.4.7.【推荐】使用解构获取对象属性。eslint: [prefer-destructuring](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/prefer-destructuring.md)
...
- 2.4.9.【强制】不要直接在对象上调用 `Object.prototypes` 上的方法。`eslint`: [no-prototype-builtins](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-prototype-builtins.md)
...
- 2.5.1.【强制】不要用 Function 构造函数创建函数。`eslint`: [no-new-func](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-new-func.md)
...
- 2.5.2.【强制】不要在块中使用函数声明。`eslint`: [no-inner-declarations](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-inner-declarations.md)
...
- 2.5.4.【强制】使用箭头函数代替匿名函数。`eslint`: [prefer-arrow-callback](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/prefer-arrow-callback.md)
...
- 2.5.5.【推荐】箭头函数编码风格。`eslint`: [arrow-parens](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/arrow-parens.md) [arrow-body-style](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/arrow-body-style.md)
...
- 2.5.7.【强制】不要使用 `arguments` 对象。`eslint`: [prefer-rest-params](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/prefer-rest-params.md)
...
- 2.5.10.【推荐】不要修改函数参数。`eslint`: [no-param-reassign](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-param-reassign.md)
...
- 2.5.11.【强制】将立即执行函数表达式（`IIFE`）用小括号包裹。`eslint`: [wrap-iife](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/wrap-iife.md)
...
- 2.5.12.【参考】函数的复杂度不应过高。`eslint`: [complexity](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/complexity.md)
...
- 2.5.13.【参考】函数的参数不应过多。`eslint`: [max-params](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/max-params.md)
...
- 2.5.14.【强制】`generator` 函数内必须有 `yield` 语句。`eslint`: [require-yield](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/require-yield.md)
...
- 2.6.3.【强制】避免不必要的 constructor。
  ...
  ES6 class 会提供一个默认的 `constructor`，空 `constructor` 或者只调用父类的  `constructor` 是不必要的。eslint: [no-useless-constructor](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-useless-constructor.md)
...
- 2.6.4.【强制】正确地使用 super 方法。eslint: [constructor-super](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/constructor-super.md) [no-this-before-super](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-this-before-super.md)
...
- 2.6.5.【强制】避免重复的类成员命名。eslint: [no-dupe-class-members](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-dupe-class-members.md)
...
- 2.8.1.【推荐】使用严格相等运算符。eslint: [eqeqeq](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/eqeqeq.md)
...
- 2.8.2.【强制】不要使用一元自增自减运算符。`eslint`: [no-plusplus](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-plusplus.md)
...
- 2.8.3.【强制】不要使用 `void` 运算符。`eslint`: [no-void](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-void.md)
...
- 2.8.4.【强制】避免嵌套的三元表达式。`eslint`: [no-nested-ternary](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-nested-ternary.md)
...
- 2.8.5.【强制】避免不必要的三元表达式。`eslint`: [no-unneeded-ternary](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-unneeded-ternary.md)
...
- 2.8.6.【强制】混合使用多种操作符时，用小括号包裹分组。`eslint`: [no-mixed-operators](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-mixed-operators.md)
...
- 2.9.1.【强制】`switch` 语句中的 `case` 需要以 `break` 结尾。`eslint`: [no-fallthrough](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-fallthrough.md)
...
- 2.9.2.【推荐】`switch` 语句需要始终包含 `default` 分支。`eslint`: [default-case](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/default-case.md)
...
- 2.9.4.【参考】控制语句的嵌套层级不要过深。`eslint`: [max-depth](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/max-depth.md)
...
- 2.9.5.【强制】for 循环中的计数器应朝着正确方向移动。`eslint`: [for-direction](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/for-direction.md)
...
- 2.9.6.【推荐】`for-in` 循环中需要对 `key` 进行验证。`eslint`: [guard-for-in](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/guard-for-in.md)
...
- 2.9.7.【参考】如果一个 `if` 语句的结果总是返回一个 `return` 语句，那么最后的 `else` 是不必要的。`eslint`: [no-else-return](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-else-return.md)
...
- 2.10.1.【强制】禁止使用 `eval`。`eslint`: [no-eval](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-eval.md)
...
- 2.10.2.【强制】禁止使用 `debugger`。`eslint`: [no-debugger](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-debugger.md)
...
- 2.10.3.【推荐】禁止使用 `alert`。`eslint`: [no-alert](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-alert.md)
...
- 2.10.4.【推荐】生产环境禁止使用 `console`。eslint: [no-console](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-console.md)
...
- 2.10.5.【强制】禁止对原生对象或只读的全局对象进行赋值。`eslint`: [no-global-assign](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-global-assign.md)
...
- 3.3.【强制】注释内容和注释符之间需要有一个空格。eslint: [spaced-comment](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/spaced-comment.md)
...
- 3.4.【参考】合理使用特殊注释标记。eslint: [no-warning-comments](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-warning-comments.md)
...
- 4.2.【参考】使用小驼峰（`camelCase`）命名原始类型、对象、函数、实例。[camelcase](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/camelcase.md)
...
- 4.3.【强制】使用大驼峰（`PascalCase`）命名类和构造函数。`eslint`: [new-cap](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/new-cap.md)
...
- 4.6.【参考】命名不要以下划线开头或结尾。`eslint`: [no-underscore-dangle](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/no-underscore-dangle.md)
...
- [ESLint rules](https://github.com/eslint/eslint/blob/v8.7.0/docs/rules/)
