...
- 1.1.1.【强制】所有声明都应该以分号结尾，不能省略。`stylelint`: [declaration-block-trailing-semicolon](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/declaration-block-trailing-semicolon)
...
- 1.1.2.【推荐】使用 2 个空格缩进，不要使用 4 个空格或 tab 缩进。`stylelint`: [indentation](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/indentation)
...
- 1.1.3.【推荐】选择器和 `{` 之间保留一个空格。`stylelint`: [block-opening-brace-space-before](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/block-opening-brace-space-before)
...
- 1.1.4.【推荐】属性名和 `:` 之前无空格，`:` 和属性值之间保留一个空格。`stylelint`: [declaration-colon-space-after](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/declaration-colon-space-after) [declaration-colon-space-before](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/declaration-colon-space-before)
...
- 1.1.5.【推荐】`>`、`+`、`~` 、`||` 等组合器前后各保留一个空格。`stylelint`: [selector-combinator-space-before](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/selector-combinator-space-before) [selector-combinator-space-after](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/selector-combinator-space-after)
...
- 1.1.6.【推荐】在使用 `,` 分隔的属性值中，`,` 之后保留一个空格。`stylelint`: [value-list-comma-space-after](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/value-list-comma-space-after)
...
- 1.1.7.【推荐】注释内容和注释符之间留有一个空格。`stylelint`: [comment-whitespace-inside](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/comment-whitespace-inside)
...
- 1.1.9.【推荐】属性声明应单独成行。`stylelint`: [declaration-block-single-line-max-declarations](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/declaration-block-single-line-max-declarations)
...
- 1.1.10.【推荐】单行代码最多不要超过 100 个字符。 `stylelint`: [max-line-length](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/max-line-length) 除了以下两种情况：
...
- 1.1.11.【参考】使用多个选择器时，每个选择器应该单独成行。`stylelint`: [selector-list-comma-newline-after](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/selector-list-comma-newline-after)
...
- 1.1.13.【参考】注释行上方需留有一行空行，除非上一行是注释或块的顶部。`stylelint`: [comment-empty-line-before](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/comment-empty-line-before)
...
- 1.2.1.【参考】不要使用 `id` 选择器。`stylelint`: [selector-max-id](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/selector-max-id)
...
- 1.2.2.【参考】属性选择器的值始终用双引号包裹。`stylelint`: [selector-attribute-quotes](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/selector-attribute-quotes)
...
- 1.3.1.【推荐】使用尽可能短的十六进制值。`stylelint`: [color-hex-length](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/color-hex-length)
...
- 1.3.3.【推荐】十六进制值统一使用小写字母（小写字母更容易分辨）。`stylelint`: [color-hex-case](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/color-hex-case)
...
- 1.3.4.【推荐】长度值为 0 时，省略掉长度单位。`stylelint`: [length-zero-no-unit](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/length-zero-no-unit)
...
- 1.3.5.【参考】保留小数点前的 0。`stylelint`: [number-leading-zero](https://github.com/stylelint/stylelint/tree/15.11.0/lib/rules/number-leading-zero)
